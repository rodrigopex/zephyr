...
ZBUS_CHAN_DEFINE(raw_data_chan, false, struct sensor_msg, NULL, ZBUS_OBSERVERS_EMPTY,
		 ZBUS_MSG_INIT(.x = 0, .y = 0, .z = 0));

ZBUS_CHAN_DEFINE(state_chan, false, bool, NULL, ZBUS_OBSERVERS(state_change_sub), false);
