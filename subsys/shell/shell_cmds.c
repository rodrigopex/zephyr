...
SHELL_CREATE_STATIC_SUBCMD_SET(
    m_sub_colors, SHELL_CMD_ARG(off, NULL, SHELL_HELP_COLORS_OFF, cmd_colors_off, 1, 0),
    SHELL_CMD_ARG(on, NULL, SHELL_HELP_COLORS_ON, cmd_colors_on, 1, 0));

SHELL_CREATE_STATIC_SUBCMD_SET(
    m_sub_echo, SHELL_CMD_ARG(off, NULL, SHELL_HELP_ECHO_OFF, cmd_echo_off, 1, 0),
...
SHELL_CREATE_STATIC_SUBCMD_SET(m_sub_backspace_mode,
                               SHELL_CMD_ARG(backspace, NULL,
                                             SHELL_HELP_BACKSPACE_MODE_BACKSPACE,
                                             cmd_bacskpace_mode_backspace, 1, 0),
                               SHELL_CMD_ARG(delete, NULL,
                                             SHELL_HELP_BACKSPACE_MODE_DELETE,
                                             cmd_bacskpace_mode_delete, 1, 0));

SHELL_CREATE_STATIC_SUBCMD_SET(
    m_sub_shell,
    SHELL_CMD(backspace_mode, &m_sub_backspace_mode, SHELL_HELP_BACKSPACE_MODE, NULL),
...
SHELL_CMD_ARG_REGISTER(resize, &m_sub_resize, SHELL_HELP_RESIZE, cmd_resize, 1, 1);
